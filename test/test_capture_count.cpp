...
TEST_CASE("constexpr capture group counting", "[capture_count]") {
  ...
  // H12: 64 超えのキャプチャ数を constexpr 経路で検証
  constexpr auto pat66 =
    ...
    "(a)(a)(a)(a)(a)(a)";             // 66
  static_assert(count_capture_groups(pat66) == 66);

  // H12: branch reset (?|...) でも 64 超えを検証
  constexpr auto br66 =
    "(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))"  // 5
    "(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))"  // 10
    "(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))"  // 15
    "(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))"  // 20
    "(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))"  // 25
    "(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))"  // 30
    "(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))"  // 35
    "(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))"  // 40
    "(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))"  // 45
    "(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))"  // 50
    "(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))"  // 55
    "(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))"  // 60
    "(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))(?|(a)|(b))"  // 65
    "(?|(a)|(b))";                                               // 66
  static_assert(count_capture_groups(br66) == 66);
}
